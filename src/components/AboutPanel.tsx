...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "Cloudmoji has no accounts and does not collect names or child profiles. Usage stats are stored only on your device and never sent anywhere.\n\nIf a grown-up chooses to email support, we receive their email address and whatever they choose to write. Please do not include personal information about your child.",
  },
  {
    q: "How do I contact support?",
    a: "Email Kevin at kevin.chan@sproutlearn.co. Please include your device, operating-system version, Cloudmoji version, and what happened — but no names, photos, recordings, or other personal information about your child.",
  },
];
